...
public class MainActivity extends AppCompatActivity {
    ...
    private void addNewCar() {
        ...
        Car car = new Car(makerEditText.getText().toString(), modelEditText.getText().toString(),
                Integer.parseInt(yearEditText.getText().toString()), colorEditText.getText().toString(),
                        Integer.parseInt(seatsEditText.getText().toString()), Double.parseDouble(priceEditText.getText().toString()));
        cars.add(car);
